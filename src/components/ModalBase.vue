  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          :class="[
            'relative flex w-full flex-col rounded-[10px] border border-black/10 bg-white shadow-xl',
        ...
        >
          <button
            type="button"
            class="absolute right-4 top-4 z-10 flex size-8 items-center justify-center rounded text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
            aria-label="Cerrar"
          ...
          <header class="shrink-0 flex flex-col gap-2 px-6 pt-6 pr-12">
          ...
          <footer v-if="$slots.footer" class="shrink-0 flex justify-end gap-2 border-t border-black/10 px-6 pb-6 pt-4">
            <slot name="footer" />
          </footer>
        </div>
      </div>
